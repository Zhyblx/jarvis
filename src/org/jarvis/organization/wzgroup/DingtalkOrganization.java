...
public class DingtalkOrganization {
    ...
    private String tokenID() {
        return "25c22189ee873c5bbb69e30fae5c384f";
    }
...
//        System.out.println(result.get("name"));
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(Arrays.toString(new DingtalkOrganization().getListSubDepartmentID(1l)));// 获取一级部门ID列表

        HashMap<String, String> hashMap = new DingtalkOrganization().getListDepartments(499426523);//获取具体一级部门下的下一级部门列表；并输出部门名称
        System.out.println(hashMap.get("499415431"));

        System.out.println(Arrays.toString(new DingtalkOrganization().getListUserDepartments(499415431)));//获取具体部门下的用户ID
        System.out.println(new DingtalkOrganization().getUserDetails("manager1437"));//获取用户的详情
